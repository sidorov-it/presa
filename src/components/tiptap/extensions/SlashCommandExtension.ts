...
const getIconSvg = (iconName: string): string => {
    ...
    return iconMap[componentName] || '<svg viewBox="0 0 24 24" width="1em" height="1em" stroke="currentColor" fill="none"><circle cx="12" cy="12" r="5"/></svg>';
};
